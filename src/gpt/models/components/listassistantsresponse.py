...
import dataclasses
from .assistantobject import AssistantObject
...
class ListAssistantsResponse:
    data: List[AssistantObject] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
