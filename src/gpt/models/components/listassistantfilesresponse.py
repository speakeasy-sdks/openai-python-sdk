...
import dataclasses
from .assistantfileobject import AssistantFileObject
...
class ListAssistantFilesResponse:
    data: List[AssistantFileObject] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
