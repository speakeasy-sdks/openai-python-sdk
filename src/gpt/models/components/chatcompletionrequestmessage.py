...
class AssistantMessage:
    ...
    r"""The role of the messages author, in this case `assistant`."""
    content: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('content') }})
...
@dataclasses.dataclass
class UserMessage:
    content: Union[str, List[Union[TextContentPart, ImageContentPart]]] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('content') }})
