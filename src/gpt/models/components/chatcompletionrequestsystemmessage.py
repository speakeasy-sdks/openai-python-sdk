...
class ChatCompletionRequestSystemMessageRole(str, Enum):
...
class ChatCompletionRequestSystemMessage:
    ...
    role: ChatCompletionRequestSystemMessageRole = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('role') }})
    r"""The role of the messages author, in this case `system`."""
