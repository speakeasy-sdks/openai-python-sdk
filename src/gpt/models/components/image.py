...
class Image:
    ...
    revised_prompt: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('revised_prompt'), 'exclude': lambda f: f is None }})
