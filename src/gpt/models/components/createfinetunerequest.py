...
class CreateFineTuneRequest1(str, Enum):
...
class Hyperparameters:
    ...
    n_epochs: Optional[Union[CreateFineTuneRequest1, int]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('n_epochs'), 'exclude': lambda f: f is None }})
    r"""The number of epochs to train the model for. An epoch refers to one
    full cycle through the training dataset.
    """
...
class CreateFineTuneRequest2(str, Enum):
...
class CreateFineTuneRequest:
    ...
    results.
    """
    model: Optional[Union[str, CreateFineTuneRequest2]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model') }})
    r"""The name of the base model to fine-tune. You can select one of \\"ada\\",
    \"babbage\", \"curie\", \"davinci\", or a fine-tuned model created after 2022-04-21 and before 2023-08-22.
    To learn more about these models, see the
    [Models](/docs/models) documentation.
