...
class CreateChatCompletionRequestType(str, Enum):
    r"""Setting to `json_object` enables JSON mode. This guarantees that the message the model generates is valid JSON.
...
class ResponseFormat:
    r"""An object specifying the format that the model must output. Used to enable JSON mode."""
