...
from ...models.components import listmessagesresponse as components_listmessagesresponse
from enum import Enum
from typing import Optional

class ListMessagesQueryParamOrder(str, Enum):
...
class ListMessagesRequest:
    ...
    r"""The ID of the [thread](/docs/api-reference/threads) the messages belong to."""
...
class ListMessagesResponse:
    ...
    list_messages_response: Optional[components_listmessagesresponse.ListMessagesResponse] = dataclasses.field(default=None)
    r"""OK"""
