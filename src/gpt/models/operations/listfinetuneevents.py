...
from ...models.components import listfinetuneeventsresponse as components_listfinetuneeventsresponse
...
class ListFineTuneEventsResponse:
    ...
    list_fine_tune_events_response: Optional[components_listfinetuneeventsresponse.ListFineTuneEventsResponse] = dataclasses.field(default=None)
    r"""OK"""
