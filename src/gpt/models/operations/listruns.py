...
from ...models.components import listrunsresponse as components_listrunsresponse
from enum import Enum
from typing import Optional

class ListRunsQueryParamOrder(str, Enum):
...
class ListRunsRequest:
    ...
    r"""The ID of the thread the run belongs to."""
    ...
    order: Optional[ListRunsQueryParamOrder] = dataclasses.field(default=ListRunsQueryParamOrder.DESC, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    r"""Sort order by the `created_at` timestamp of the objects. `asc` for ascending order and `desc` for descending order."""
