...
from ...models.components import listfinetuningjobeventsresponse as components_listfinetuningjobeventsresponse
...
class ListFineTuningEventsResponse:
    ...
    list_fine_tuning_job_events_response: Optional[components_listfinetuningjobeventsresponse.ListFineTuningJobEventsResponse] = dataclasses.field(default=None)
    r"""OK"""
