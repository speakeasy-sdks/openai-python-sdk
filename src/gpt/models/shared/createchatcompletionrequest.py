...
@dataclasses.dataclass
class CreateChatCompletionRequestLogitBias:
...
class CreateChatCompletionRequest:
    ...
    logit_bias: Optional[CreateChatCompletionRequestLogitBias] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logit_bias'), 'exclude': lambda f: f is None }})
    r"""Modify the likelihood of specified tokens appearing in the completion.
