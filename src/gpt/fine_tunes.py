...
class FineTunes:
    ...
    def cancel_fine_tune(self, fine_tune_id: str) -> operations.CancelFineTuneResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[components.FineTune])
                res.fine_tune = out
            else:
    ...
    def create_fine_tune(self, request: components.CreateFineTuneRequest) -> operations.CreateFineTuneResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, components.CreateFineTuneRequest, "request", False, False, 'json')
    ...
    def list_fine_tune_events(self, fine_tune_id: str, stream: Optional[bool] = None) -> operations.ListFineTuneEventsResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[components.ListFineTuneEventsResponse])
    ...
    def list_fine_tunes(self) -> operations.ListFineTunesResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[components.ListFineTunesResponse])
    ...
    def retrieve_fine_tune(self, fine_tune_id: str) -> operations.RetrieveFineTuneResponse:
