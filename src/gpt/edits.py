...
class Edits:
    ...
    def create_edit(self, request: components.CreateEditRequest) -> operations.CreateEditResponse:
        ...
        url = base_url + '/edits'
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, components.CreateEditRequest, "request", False, False, 'json')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[components.CreateEditResponse])
