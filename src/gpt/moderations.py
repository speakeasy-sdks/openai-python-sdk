...
class Moderations:
    ...
    def create_moderation(self, request: components.CreateModerationRequest) -> operations.CreateModerationResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, components.CreateModerationRequest, "request", False, False, 'json')
        ...
        res = operations.CreateModerationResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[components.CreateModerationResponse])
