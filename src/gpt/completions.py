...
class Completions:
    ...
    def create_completion(self, request: components.CreateCompletionRequest) -> operations.CreateCompletionResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, components.CreateCompletionRequest, "request", False, False, 'json')
        ...
        res = operations.CreateCompletionResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(http_res.headers.get('Content-Type'), 'application/json'):                
                out = utils.unmarshal_json(http_res.text, Optional[components.CreateCompletionResponse])
