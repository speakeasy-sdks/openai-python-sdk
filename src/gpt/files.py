...
class Files:
    ...
    def list_files(self, purpose: Optional[str] = None) -> operations.ListFilesResponse:
        ...
        query_params = { **utils.get_query_params(operations.ListFilesRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ListFilesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def retrieve_file(self, file_id: str) -> operations.RetrieveFileResponse:
        ...
        res = operations.RetrieveFileResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
