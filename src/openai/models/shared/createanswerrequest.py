...
class CreateAnswerRequest:
    ...
    documents: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('documents'), 'exclude': lambda f: f is None }})
    expand: Optional[list[Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('expand'), 'exclude': lambda f: f is None }})
    ...
    max_rerank: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('max_rerank'), 'exclude': lambda f: f is None }})
    ...
    return_prompt: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('return_prompt'), 'exclude': lambda f: f is None }})
