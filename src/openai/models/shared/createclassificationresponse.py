...
class CreateClassificationResponse:
    ...
    selected_examples: Optional[list[CreateClassificationResponseSelectedExamples]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('selected_examples'), 'exclude': lambda f: f is None }})
