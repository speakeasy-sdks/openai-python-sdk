...
* [modify_assistant](docs/sdks/assistant/README.md#modify_assistant) - Modifies an assistant.
...
* [create_file](docs/sdks/files/README.md#create_file) - Upload a file that can be used across various endpoints/features. The size of all the files uploaded by one organization can be up to 100 GB.
