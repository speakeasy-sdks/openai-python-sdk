...
req = components.CreateFineTuningJobRequest(
    ...
    components.CreateFineTuningJobRequest1.AUTO,
    components.CreateFineTuningJobRequestSchemas1.AUTO,
    components.CreateFineTuningJobRequestSchemasHyperparameters1.AUTO,
    ),
components.CreateFineTuningJobRequest2.GPT_3_5_TURBO,
...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `request`                                                                                  | [components.CreateFineTuningJobRequest](../../models/shared/createfinetuningjobrequest.md) | :heavy_check_mark:                                                                         | The request object to use for the request.                                                 |
